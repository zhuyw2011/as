...
/* ============================ [ DECLARES  ] ====================================================== */
#ifdef MULTIPLY_TASK_PER_PRIORITY
#define NEW_PRIORITY(prio) (((uint16)(prio)<<SEQUENCE_SHIFT)|((--pReadyQueue->PrioSeqVal[prio])&SEQUENCE_MASK))
...
static void Sched_AddReadyInternal(ReadyQueueType* pReadyQueue, TaskType TaskID, PriorityType priority)
{
