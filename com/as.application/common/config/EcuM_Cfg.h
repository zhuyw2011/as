...
#define ECUM_WKSOURCE_POWER (1<<0)
#define ECUM_WKSOURCE_RESET (1<<1)
#define ECUM_WKSOURCE_INTERNAL_RESET (1<<2)
#define ECUM_WKSOURCE_INTERNAL_WDG (1<<3)
#define ECUM_WKSOURCE_EXTERNAL_WDG (1<<4)
#define ECUM_WKSOURCE_ECUMWAKEUPSOURCE (1<<5)	
#define ECUM_WKSOURCE_ALL_SOURCES 0x3FFFFFFF
